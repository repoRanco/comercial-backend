"""006-A-CCMax.py - ETL Aereo CCMax. Uso: python 006-A-CCMax.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 006-A-CCMax.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
