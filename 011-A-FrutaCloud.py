"""011-A-FrutaCloud.py - ETL Aereo FrutaCloud. Uso: python 011-A-FrutaCloud.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 011-A-FrutaCloud.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
