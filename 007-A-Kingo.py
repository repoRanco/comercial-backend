"""007-A-Kingo.py - ETL Aereo Kingo. Uso: python 007-A-Kingo.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 007-A-Kingo.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
