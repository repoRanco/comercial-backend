"""006-M-CCMax.py - ETL Maritimo CCMax. Uso: python 006-M-CCMax.py <input.xlsx> <output.xlsx>"""
...
COLUMNAS_OPCIONALES=["Calibre","Marca","Envop"]               # Se rellenan con default si faltan
...
def encontrar_fila_header(ruta):
    ...
    # Palabras clave que indican fila de header (en cualquier idioma)
...
def main():
    if len(sys.argv)<3:print("Uso: python 006-M-CCMax.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
