"""005-A-SunVirtue.py - ETL Aéreo SunVirtue. Uso: python 005-A-SunVirtue.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 005-A-SunVirtue.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
