"""010-A-Qinguo.py - ETL Aereo Qinguo. Uso: python 010-A-Qinguo.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 010-A-Qinguo.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
