"""008-A-Xianfeng.py - ETL Aereo Xianfeng. Uso: python 008-A-Xianfeng.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 008-A-Xianfeng.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
