"""009-A-HingLee.py - ETL Aereo HingLee. Uso: python 009-A-HingLee.py <input.xlsx> <output.xlsx>"""
...
def main():
    if len(sys.argv)<3:print("Uso: python 009-A-HingLee.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
