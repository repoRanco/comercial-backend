"""004-M-Wonong.py - ETL Marítimo Wonong. Uso: python 004-M-Wonong.py <input.xlsx> <output.xlsx>"""
...
MAPEO_COSTOS={
    ...
    "进场费/Market Entry Fee(Market Charge ¥4500/Container)":(40,"05"),"场地费/Management Charge(Market Charge ¥50/Container/Day)":(40,"05"),"进场费/Market Entry Fee":(40,"05"),
    "打冷费/Cooling Charge(Market Charge ¥200/Container/Day)":(40,"06"),"场地费/Management Charge":(40,"06"),"打冷费/Cooling Charge":(40,"06"),
    "装卸费/Stevedoring Charge(Market Charge ¥16/Pallet)":(40,"07"),"装卸费/Stevedoring Charge":(40,"07"),
    "吊柜费/Container Hoisting Charge(Market Charge ¥260/Container)":(40,"08"),"吊柜费/Container Hoisting Charge":(40,"08"),
    "C6其他费用/Other":(40,"11"),"C6其他费用/Other Trucking":(40,"10"),"C6其他费用/Other Trucking to SH":(40,"10"),
    "Repack":(40,"09"),"C2海运费/Ocean Freight":(41,"01"),"C2运费/Air Freight($6*G.W)":(41,"01"),"C2运费/Charter Freight":(41,"01"),
}
...
def main():
    if len(sys.argv)<3:print("Uso: python 004-M-Wonong.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
