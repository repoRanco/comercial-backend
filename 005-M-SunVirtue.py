"""005-M-SunVirtue.py - ETL Marítimo SunVirtue. Uso: python 005-M-SunVirtue.py <input.xlsx> <output.xlsx>"""
import sys,os,logging,pandas as pd
logging.basicConfig(level=logging.INFO,format='%(asctime)s - %(levelname)s - %(message)s')
logger=logging.getLogger(__name__)
MAPEO_COLUMNAS={'Variety':'Variedad','Size':'Calibre','Brand':'Marca','Packing':'Envop','Quantity':'Cantidad','Unit Price':'PrecioUnitario'}
MAPEO_COSTOS={
    "VAT":(40,"01"),"Import VAT":(40,"01"),
    "Commission":(40,"02"),"Service Charge":(40,"02"),
    ...
    "Container Charges":(40,"08"),
    "Other Charges":(40,"11"),"Other Expenses":(40,"11"),
    "Truck Charges":(40,"10"),"Trucking":(40,"10"),
    "Repack":(40,"09"),
    "Ocean Freight":(41,"01"),"Air Freight":(41,"01"),
}
SUBITEMS_40=["01","02","04","05","06","07","08","09","10","11"];SUBITEMS_41=["01"]
PALABRAS_FIN_DATOS=['TOTAL','Total'];COLUMNAS_REQUERIDAS=['Variedad','Calibre','Marca','Envop','Cantidad','PrecioUnitario']
...
def encontrar_fila_header(ruta):
    ...
    for idx,row in df_temp.iterrows():
        ...
        if 'Variety' in s and 'Size' in s and 'Quantity' in s:return idx
    return 3
...
def main():
    if len(sys.argv)<3:print("Uso: python 005-M-SunVirtue.py <input.xlsx> <output.xlsx>",file=sys.stderr);sys.exit(1)
